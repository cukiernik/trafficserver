...
UDPNetHandler::mainNetEvent(int event, Event *e)
{
  ...
  return this->waitForActivity(net_config_poll_timeout, ProtectedQueue::allnodes);
}

int
UDPNetHandler::waitForActivity(ink_hrtime timeout, enum  ProtectedQueue::numa_node )
{
